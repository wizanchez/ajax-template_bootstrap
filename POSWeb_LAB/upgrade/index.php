...
if(isset($_GET['process']))
{
	...
	$upgradetable3=$cfg_tableprefix.'items';
	$upgradetable4=$cfg_tableprefix.'discounts';
    ...
    $query5="ALTER TABLE $upgradetable3 ADD reorder_level INT( 8 ) NOT NULL AFTER quantity;";
	$query6="CREATE TABLE $upgradetable4 (
