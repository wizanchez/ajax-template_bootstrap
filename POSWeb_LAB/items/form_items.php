...
if($action=="update")
{
	...
	if(isset($_GET['id']))
	{
		...
		$pastill_value = $row['pack'];
		$id=$row['id'];
		$shortdescription_value=$row['shortdescription'];
	    $state =$row['active'];
	}
...
$f1->createInputField("<b>$lang->description:</b> ",'text','description',"$description_value",'24','160');
$f1->createInputField("<b>$lang->shortdescription:</b> ",'text','shortdescription',"$shortdescription_value",'24','160');
$f1->createInputField("<b>$lang->itemNumber:</b> ",'text','item_number',"$item_number_value",'24','160');
...
$f1->createInputField("<b>$lang->supplierCatalogue:</b> ",'text','supplier_catalogue_number',"$supplier_catalogue_number_value",'24','160');
...
$f1->createInputField("<b>$lang->pastill:</b> ",'text','pastill',"$pastill_value",'3','160');
     
echo"<tr bgcolor='DDDDDD'>
    <td><b>$lang->state:</b></td><td><select  name=\"state\" id=\"state\">";
         	echo '<option value="1"';if(!(strcmp(1, $state))){echo $selected = "selected=\"selected\"";}echo '>Activo</option>';
		    echo '<option value="0"';if(!(strcmp(0, $state))){echo $selected = "selected=\"selected\"";}echo '>Inactivo</option>';
			echo"</select></td></tr>";
