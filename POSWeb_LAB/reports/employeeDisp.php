...
$display->displayTitle("$cfg_company $lang->employeeDisReport");
...
$display->displayReportTableDispe("$cfg_tableprefix",'sales',$tableheaders,$tablefields,'sold_by',"$selected_employee","$date1","$date2",'date',"$lang->listOfDisBy $display_name<br>$lang->between $date1 and $date2");
