...
$display->displayTitle("$lang->manageEvento");



$f1 = new form('manage_evento.php','POST','sales','450',$cfg_theme,$lang);

$f1->createInputField("<b>$lang->searchForDistri</b>",'text','search',"$lang->highID".
...
if (isset($_POST['search'])) {
	...
	$display->displayEventoManagerTable("$cfg_tableprefix",$id2,$id1,'id');



} else {

	$display->displayEventoManagerTable("$cfg_tableprefix",'','','id');
