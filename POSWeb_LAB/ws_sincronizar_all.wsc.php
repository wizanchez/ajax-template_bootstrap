<?php									
										...
										define(MAX_REGISTRO_PACIENTES_WS,'5000');
												...
												#----------------------------------------------------------------------------------------
												#	OPCION PARA SINCRONIZAR UN PIACIENTE LOS BOTONES 
															define(DF_SINCRONIZAR_PACIENTES,false);
												#----------------------------------------------------------------------------------------
	#########################################################################################################################################################
...
class ws_sinronizar_all{
	...
	$tiempo = microtime();$tiempo = explode(" ", $tiempo);$tiempo = $tiempo[1] + $tiempo[0];$tiempoInicial = $tiempo;
			...
			echo'<br>********************************************************************************************<br>';	
			echo'<br>********Obteniendo Resultados del web service '.URL_WEB_ws.'<br>';	
			echo'<br>********Resultados Obtenidos en un total de '.count($item_list).' Registros<br>';	
			$insert=0;	 
			$update=0;	 
			...
			echo'<br>********<strong>Total Insertados</strong> en Forma Basica  en '.$insert.' <br>';	
			echo'<br>********<strong>Total Actualizados</strong> en Forma Basica  en '.$update.' <br>';	
   	$tiempo 	= microtime();$tiempo = explode(" ", $tiempo);
	$tiempo 	= $tiempo[1] + $tiempo[0];
	$tiempoFinal = $tiempo; // Cálculo de la diferencia de tiempo
  	$tiempoTotal = $tiempoFinal - $tiempoInicial;
			echo'<br>********************************************************************************************<br>';	
			echo'<br>********<strong>Actualizado</strong> en Forma Basica  en '.number_format($tiempoTotal,2).' segundos <br>';	
  	...
  	$tiempoTotal = $tiempoFinal - $tiempoInicial;
			echo'<br>********************************************************************************************<br>';	
			echo'<br>********<strong>Actualizado</strong> en Forma Basica  en '.number_format($tiempoTotal/60,3).' Minutos <br>';	
 ...
 <p>
    ...
    <table  border="0" cellspacing="0" cellpadding="0" style="font:Verdana, Geneva, sans-serif; size:2;">
     ...
     <?PHp if(DF_SINCRONIZAR_PACIENTES==true){?>
          <tr>
            <td width="300" class="popScripts EfectoZoom popScriptLink">
