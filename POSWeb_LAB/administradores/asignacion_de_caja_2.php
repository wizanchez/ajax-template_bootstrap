...
/*function sumDate($hora1, $hora2){	// Imprime la nueva hora apartir de la suma otras dos
	//$hora1="2:30";
	//$hora2="3:42";
	$hora1=split(":",$hora1);
	$hora2=split(":",$hora2);
...
<script src="../js/timespinner2.js"></script>
...
<?=$userid?>
 <form name="forms">    
  ...
  <table width="400" border="0" align="center"  cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td align="center"><?=$Tex->BarraTitulo('Valor Base','<input name="base" type="text" class="cajas" id="base" onchange="validarint(this)" size="12" maxlength="8" value="'.$cfg_start_balance.'" style="text-align:center"/> ','f_contratoDIV')?></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>
    <?=$Tex->BarraTitulo('Hora Final','<input type="text" name="hora_2"  size="15"	value="'.$horaact.'" id="hora_2" style="text-align:center" class="cajas"  />','f_contratoDdIV')?>
    <input type="hidden" name="message" id="message" size="30"/>
...
var spinner1_2 = new TimeSpinner2($('hora_2'));
