		...
		if(xmlDoc.getElementsByTagName("cantinv")[0].childNodes[0].nodeValue != 0 && xmlDoc.getElementsByTagName("price")[0].childNodes[0].nodeValue != 0 && xmlDoc.getElementsByTagName("cost")[0].childNodes[0].nodeValue != 0)
		  {
			...
			var sig = 0;	
			var inv = '';
			 /* if(xmlDoc.getElementsByTagName("price")[0].childNodes[0].nodeValue == 0 && sig = 0) {  inv = 'Precio 0'; sig = 1; }
			 if (xmlDoc.getElementsByTagName("cost")[0].childNodes[0].nodeValue == 0 && sig = 0) {  inv = 'Costo 0'; sig = 1; }*/
			 alert('Este producto no puede ser facturado. '+inv);	
