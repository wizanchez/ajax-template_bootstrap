...
<table  width="10px" border="0">
    ...
    <span><strong><?= strtoupper($lang->phoneNumber)?>: </strong><?= $cfg_phone?> <strong><?= strtoupper($lang->fax)?>:</strong> <?= $cfg_fax?></span><br /><?php }?>
	<?php if ($cfg_email != '') {?>   
    <span><strong><?= strtoupper($lang->email)?>: </strong><?= $cfg_email?> <strong><br /> <?php }?>
<?php if ($cfg_website != '') {?>   
    <span><strong><?= strtoupper($lang->website)?>: </strong><a href="<?= $cfg_website?>"><?= $cfg_website?></a><br /> <?php }?>       
        <span>
        ...
        <span ><strong><?= strtoupper($lang->date)?>: </strong><?= $tipo_f['date']?></span><span style="float: right;"><strong><?= strtoupper($lang->hoursec)?>_RE: </strong><?= date('h:m:s')
?></span><br />
...
?>
    <tr>
        ...
        <td nowrap style="font-size: 8px;line-height: 10px; font-family: Arial, serif; text-align: left;"><?= $itemdesc?></td>
...
?>
    ...
    <tr>
        <td nowrap colspan="6" style="font-size: 9px;line-height: 10px; font-family: Arial, serif; " align="center" ><strong><?= str_pad($lang->dettax,50,"-",STR_PAD_BOTH);?></strong>
        </td>
    <tr>
        <td nowrap colspan="6">        
        <table width="100%">
	...
	while ($row = mysql_fetch_assoc($result)) {
        ...
        <tr>
            <td nowrap style="font-size: 8px;line-height: 10px; font-family: Arial, serif; text-align: left;"><?= trim($row['item_tax_percent'])?> %</td>
            <td nowrap style="font-size: 8px;line-height: 10px; font-family: Arial, serif; text-align: right;"><?= trim($row['item_tax_percent'])?></td>
            <td nowrap style="font-size: 8px;line-height: 10px; font-family: Arial, serif; text-align: right;">
            <?= trim($rowb['base'])?>        
            </td>
            <td nowrap style="font-size: 8px;line-height: 10px; font-family: Arial, serif; text-align: right;"><?= trim($rowb['iva'])?>        
            </td> 
        </tr>
        <? }
	}?>
    ...
    <tr>
        <td nowrap colspan="6" style="font-size: 9px;line-height: 10px; font-family: Arial, serif; " align="center" >
        <strong><?= str_pad(strtoupper($lang->paidWithdet),50,"-",STR_PAD_BOTH);?></strong>
        </td>
    <tr>
    <tr>
        <td nowrap colspan="2" style="font-size: 8px;line-height: 10px; font-family: Arial, serif; text-align: center;">
        <strong><?= strtoupper($lang->type)?></strong>
        </td>
        <td nowrap colspan="2" style="font-size: 8px;line-height: 10px; font-family: Arial, serif; text-align: center;">
        <strong><?= strtoupper($lang->entity)?></strong>
        </td>
        <td nowrap colspan="2" style="font-size: 8px;line-height: 10px; font-family: Arial, serif; text-align: center;">
        <strong><?= strtoupper($lang->extendedPrice)?></strong>
        </td>
...
?>
    ...
    <td nowrap colspan="5" style="font-size: 8px;line-height: 10px; font-family: Arial, serif; text-align: center;"><strong><?= strtoupper($lang->amtChange)?></strong>
     ...
     <td nowrap style="font-size: 8px;line-height: 10px; font-family: Arial, serif; text-align: right;"><?=($TotalFact-($TotalPrice-$TotalDcto-$descuent+$Totalimpto))?>
        </td>
    </tr>    
</table>
...
<tr>
    ...
    <span><strong><?= strtoupper($lang->desdeno)?>: </strong><strong><?= $cfg_pref_fac?> - <?= str_pad($cfg_fact_desde,6,"0",STR_PAD_LEFT)?> </strong><strong><?= strtoupper($lang->hastano)?>:</strong> <strong><?= $cfg_pref_fac?> - <?= str_pad($cfg_fac_hasta,6,"0",STR_PAD_LEFT)?></strong></span><br /><?php }?>        
        <span>
        </td>
</tr>
</table>
...
<?php $TotalCant += $itemqty;
			$TotalPrice += (($itemprice + $itemdcto) * $itemqty);
			$TotalDcto += ($itemdcto * $itemqty);
			($itemprice * ($row['item_tax_percent'] / 100)) * ($itemqty);
		}
?>
    <tr>
    ...
    <tr>
        <td nowrap style="font-size: 8px;line-height: 10px; font-family: Arial, serif; text-align: center;"><?= number_format($TotalCant,'0','','.')?></td>
        <td nowrap style="font-size: 8px;line-height: 10px; font-family: Arial, serif; text-align: center;"><?= number_format($TotalPrice,'0','','.')?></td>
        <td  style="font-size: 8px;line-height: 10px; font-family: Arial, serif; text-align: center;" nowrap><?= number_format($TotalDcto,'0','','.')?></td>
        <td  style="font-size: 8px;line-height: 10px; font-family: Arial, serif; text-align: center;" nowrap><?= number_format($descuent,'0','','.')?></td>
...
<tr>
    ...
    <span><strong><?= strtoupper($lang->res_fact)?> </strong></span><br /><span><strong><?= strtoupper($cfg_res_fact)?></strong></span><br />
    <span><strong><?= strtoupper($lang->desdeno)?>: </strong><strong><?= $cfg_pref_fac?> - <?= str_pad($cfg_fact_desde,6,"0",STR_PAD_LEFT)?> </strong><strong><?= strtoupper($lang->hastano)?>:</strong> <strong><?= $cfg_pref_fac?> - <?= str_pad($cfg_fac_hasta,6,"0",STR_PAD_LEFT)?></strong></span><br /><?php }?>        
        <br><br><br><br>______________________________<br>
		Firma : Paciente	
        </td>
</tr>
</table>
<?php }
	...
	if (mysql_num_rows($result) > 0) {
		...
		$customer_name = $dbf->idToField('pos_pacientes','first_name',$cliente).' '.$dbf->idToField('pos_pacientes','last_name',$cliente);$customer_codigo = $dbf->idToField('pos_pacientes','account_number',$cliente);
		$convenioid = $dbf->idToField('pos_pacientes','convenioid',$cliente);?>
...
<table  width="10px">
    <tr>
        <td nowrap align="center" style="font-size: 9px;line-height: 12px; font-family: Arial, serif; text-align: center" colspan="7">
        <span><strong><?= strtoupper($cfg_company)?></span><br /><span><?= strtoupper($lang->nit)?><?= strtoupper($cfg_company_nit)?></span>
        </td>
    </tr>
    <tr>
        <td nowrap style="font-size: 8px;line-height: 10px; font-family: Arial, serif; " align="left" colspan="7">
...
<?php if ($cfg_website != '') {?>   
    <span><strong><?= strtoupper($lang->website)?>: </strong><a href="<?= $cfg_website?>"><?= $cfg_website?></a><br /> <?php }?>       
        ...
        <span><strong><?= strtoupper($lang->cashier)?>: </strong><?= strtoupper($NameUser)?></span><br />
        <span ><strong><?= strtoupper($lang->Paciente)?>: </strong>	<?= $customer_codigo?> <?= $customer_name?></span><br />
        <span ><strong><?= strtoupper($lang->convenio)?>: </strong><?= $dbf->idToField('pos_convenios','convenom',$convenioid)?></span>
        <span style="float: right;"><strong><?= strtoupper($lang->convenum)?>: </strong><?= $dbf->idToField('pos_convenios','convenum',$convenioid)?></span><br />
        <span ><strong><?= strtoupper($lang->date)?>: </strong><?= $tipo_f['date']?></span>
        <span style="float: right;"><strong><?= strtoupper($lang->hoursec)?>: </strong><?= date('h:m:s')?></span><br />
...
?>
    ...
    <tr>
        <td nowrap style="font-size: 8px;line-height: 10px; font-family: Arial, serif; text-align: center;"><strong><?= strtoupper($lang->tqty_tit)?></strong></td>
        <td nowrap style="font-size: 8px;line-height: 10px; font-family: Arial, serif; text-align: center;"><strong><?= strtoupper($lang->extendedPrice)?></strong></td>
        <td  style="font-size: 8px;line-height: 10px; font-family: Arial, serif; text-align: center;" nowrap><strong><?= strtoupper($lang->dstoI)?></strong></td>
        <td  style="font-size: 8px;line-height: 10px; font-family: Arial, serif; text-align: center;" nowrap><strong><?= strtoupper($lang->dstoF)?></strong> </td>       <td nowrap style="font-size: 8px;line-height: 10px; font-family: Arial, serif; text-align: center;" colspan="3"><strong><?= strtoupper($lang->tot)?></strong></td>  
    </tr> 
    <tr>
        <td nowrap style="font-size: 8px;line-height: 10px; font-family: Arial, serif; text-align: center;"><?= number_format($TotalCant,'0','','.')?></td>
        <td nowrap style="font-size: 8px;line-height: 10px; font-family: Arial, serif; text-align: center;"><?= number_format($TotalPrice,'0','','.')?></td>
        <td  style="font-size: 8px;line-height: 10px; font-family: Arial, serif; text-align: center;" nowrap><?= number_format($TotalDcto,'0','','.')?></td>
        <td  style="font-size: 8px;line-height: 10px; font-family: Arial, serif; text-align: center;" nowrap><?= number_format($descuent,'0','','.')?>   </td>
        <td nowrap style="font-size: 8px;line-height: 10px; font-family: Arial, serif; text-align: right;" colspan="3"><?= number_format(($TotalPrice - $TotalDcto - $descuent + $Totalimpto),'0','','.')?>        
        </td>  
    </tr>
 <!--   <tr>
        <td nowrap colspan="6" style="font-size: 9px;line-height: 10px; font-family: Arial, serif; " align="center" nowrap><strong>< ?= str_pad($lang->
...
<tr>
        <td nowrap style="font-size: 8px;line-height: 10px; font-family: Arial, serif; " align="center" colspan="7">
        <?php if ($cfg_res_fact != '') {?>
    <span><strong><?= strtoupper($lang->res_fact)?> </strong></span><br />
    <span><strong><?= strtoupper($cfg_res_fact)?></strong></span><br />
    <span><strong><?= strtoupper($lang->desdeno)?>: </strong><strong><?= $cfg_pref_fac?> - <?= str_pad($cfg_fact_desde,6,"0",STR_PAD_LEFT)?> </strong><strong><?= strtoupper($lang->hastano)?>:</strong> <strong><?= $cfg_pref_fac?> - <?= str_pad($cfg_fac_hasta,6,"0",STR_PAD_LEFT)?></strong></span><br /><?php }?>        
    <br><br><br><br>______________________________<br>
		Firma : Paciente
     </td>
