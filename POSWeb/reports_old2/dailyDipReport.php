...
$display->displayTitle("$cfg_company $lang->dailyDipReport");
$today=date("F j, Y");
...
$display->displayReportTableDispe("$cfg_tableprefix",'sales',$tableheaders,$tablefields,'date',"$todaysDate",'','','invoicenumber',"$lang->listOfDispeBetween $today");
