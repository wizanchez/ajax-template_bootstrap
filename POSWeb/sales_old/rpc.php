		...
		if (strlen($queryString) != '') {
			...
			// eg: SELECT yourColumnName FROM yourTable WHERE yourColumnName LIKE '$queryString%' LIMIT 10
			            if($_REQUEST['tipo_vta'] == '2'){
			                $items = $dbf->getElements('pos_items, pos_itemconvenio,pos_pacientes ','pos_items.id, pos_items.item_number, pos_items.item_name, pos_itemconvenio.price_vta as unit_price, pos_items.pack, pos_items.quantity','pos_items.item_name',' LIKE "%'.$queryString.'%" and pos_items.active = 1
