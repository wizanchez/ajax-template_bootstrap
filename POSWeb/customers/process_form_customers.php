...
elseif (isset($_POST['first_name']) and isset($_POST['last_name']) and isset($_POST['account_number']) and
	isset($_POST['phone_number']) and isset($_POST['email']) and isset($_POST['street_address']) and
	isset($_POST['comments']) and isset($_POST['id']) and isset($_POST['action'])) {
	...
	if ($first_name == '' or $last_name == '' or $phone_number == '') {
		...
		$field_names = array('first_name','last_name','account_number','phone_number',
			'email','street_address','comments');
		$field_data = array("$first_name","$last_name","$account_number","$phone_number",
			"$email","$street_address","$comments");
...
?>
<br>
<a href="manage_customers.php"><?php echo $lang->manageCustomers
?>--></a>
<br>
<a href="form_customers.php?action=insert"><?php echo $lang->createNewCustomer
?>--></a>
</body>
</html>