...
class form
{
	...
	function createInputField($field_title,$input_type,$input_name,$input_value,$input_size,$td_width)
	{
		...
		<td><input type='$input_type' name='$input_name' id='$input_name' value='$input_value' size='$input_size'></td>
		</tr>\n";
	...
	function endForm($js='')
	{
		...
		echo '
		<tr>
		<td colspan=2 align=center><input type=submit value=Submit '.$js.'></td>
		</tr>
	</table>
  </center>
</form>';
