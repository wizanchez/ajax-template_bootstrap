...
//		this.addEvent( 'doChange', this.options.doChange);
	...
	fixTime: function() {
		...
		incrementohernan = this.options.hernan + h;
		this.timespinner.value =  (h<10 ? "0" : "") + incrementohernan + this.options.separator + (m<10 ? "0" : "") + m;
...
TimeSpinner2.implement(new Events, new Options);
